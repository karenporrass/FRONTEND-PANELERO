      ...
      <q-card>
        ...
        <div class="q-pa-md ">
          <q-form ref="myForm" @submit.prevent.stop="postVault()">
            <div>
              <q-input filled type="text" v-model="name_cellars" label="Digite el nombre de la bodega" lazy-rules :rules="[
                (val) =>
                  (val && val.trim().length > 0) || 'El campo es requerido',
              ]"></q-input>
              <q-input filled type="text" v-model="content" label="Digite el contenido de la bodega" lazy-rules :rules="[
                (val) =>
                  (val && val.trim().length > 0) || 'El campo es requerido',
              ]"></q-input>
             <q-select filled v-model="administrator" :options="optionsDNI" label="seleccione el DNI del administrador" lazy-rules :rules="[
                (val) =>
        ...
        <div class="q-pa-md ">
          <q-form ref="myForm" @submit.prevent.stop="putInfo()">
            <div>
              ...
              <q-select filled v-model="administrator" :options="optionsDNI" label="seleccione el DNI del administrador"
                lazy-rules :rules="[
                  (val) =>
                    (val && val.toString().trim().length > 0) ||
                    'El campo es requerido',
