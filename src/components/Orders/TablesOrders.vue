    ...
    <div class="row">
      ...
      <div id="table" class="col-10">
        ...
        <q-btn
          ...
          @click="(abrirCrear = true), limpiar()"
          ><span
            class="material-symbols-outlined q-mr-sm"
            style="font-size: 20px"
          >
            add_circle </span
          >Crear Nuevo Pedido</q-btn
        >
      </div>
            ...
            <div style="display: flex">
              <div id="inputs" class="q-mx-md">
                ...
                <q-select
                  ...
                  label="Escoja el tipo de panela"
                  lazy-rules
                  :rules="[
                    (val) =>
                      (val && val.toString().trim().length > 0) ||
                      'Llene el campo de tipo de panela',
                  ]"
                />
              </div>
              ...
              <div id="inputs">
                ...
                <q-select
                  ...
                  v-model="TipoEmpaque"
                  :options="Packing"
                  label="Escoga el tipo de empaque"
                  lazy-rules
                  :rules="[
                    (val) =>
                      (val && val.toString().trim().length > 0) ||
                      'Llene el campo de tipo de empaque',
                    /* val => val > 0 && val < 100 || 'Please type a real age' */
                  ]"
                />
                <q-select
      ...
      <q-card style="width: 400px; height: 900px">
        ...
        >
          <q-form ref="myForm" @submit.prevent.stop="putInfo()">
            <div
              id="inputs"
              style="min-width: 100px; margin-left: 30px; margin-top: 20px"
            >
              <q-input
                filled
                class="q-mb-md"
                type="number"
                v-model="documento"
                label="Digite el número de documento"
                lazy-rules
                :rules="[
                  (val) =>
                    (val && val.trim().length > 0) || 'Digite su documento',
                ]"
              />
              <q-input
                filled
              ...
              <q-input
                ...
                :rules="[
                  (val) =>
                    (val && val.trim().length > 0) || 'Digite su teléfono',
                ]"
              />
              <q-input
                filled
                ...
                :rules="[
                  (val) =>
                    (val && val.trim().length > 0) || 'Digite su dirección',
                ]"
              />
              <q-input
                filled
            ...
            <div
              id="inputs"
              style="min-width: 200px; margin-left: 30px; margin-top: 20px"
            >
              <q-input
                filled
                class="q-mb-md"
                ...
                :rules="[
                  (val) =>
                    (val && val.trim().length > 0) || 'Digite la cantidad',
                ]"
              />
              <q-select
                filled
                ...
                v-model="TipoEmpaque"
                :options="Packing"
                label="Escoja el tipo de empaque"
                lazy-rules
                :rules="[
                  (val) =>
                    (val && val.toString().trim().length > 0) ||
              ...
              <q-input
                ...
                :rules="[
                  (val) =>
                    (val && val.trim().length > 0) || 'Digite el valor total',
                ]"
              />
            </div>
...
async function putInfo() {
  const res = await orderStore.putOrder(
    index.value,
    documento.value,
    telefono.value,
    TipoPanela.value.value,
